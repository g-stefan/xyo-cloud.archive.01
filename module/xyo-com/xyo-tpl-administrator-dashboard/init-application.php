...
$this->setHtmlHeadCss($this->site."media/sys/css/xyo-tpl-administrator-dashboard.css");
$this->setHtmlFooterJs($this->site."media/sys/js/xyo-tpl-administrator-dashboard.js");
