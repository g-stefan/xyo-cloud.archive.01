...
$this->setHtmlHeadCss($this->site."media/sys/css/xyo-tpl-administrator-dashboard2.css");
$this->setHtmlFooterJs($this->site."media/sys/js/xyo-tpl-administrator-dashboard2.js");
