...
if ($this->ds) {
    ...
    $this->processModel("model-select", null, false);
    ...
    $this->processModel("model-filter", null, false);
}
...
$this->returnParameter("select_info", $select_info);
$this->returnParameter("search_value", $search_value);
$this->returnParameter("select_value", $select_value);
$this->returnParameter("nr_items", $nr_items);
$this->returnParameter("count", $count);
$this->returnParameter("page", $page);
$this->returnParameter("sort_value", $sort_value);
$this->returnParameter("sort_value_next", $sort_value_next);
