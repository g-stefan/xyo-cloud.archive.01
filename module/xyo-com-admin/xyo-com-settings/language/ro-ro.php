...
$this->set("label_system_log_module","Inregistreaza modulele care nu sunt gasite");
$this->set("label_system_log_request","Inregistreaza cererea");
$this->set("label_system_log_response","Inregistreaza raspunsul");
$this->set("label_system_log_language","Inregistreaza index care nu e gasit in limbaj");
