...
$this->setItemBefore("separator1","package_uninstall",
        "item-js",
        $this->pathBase."media/sys/images/package-uninstall-32.png",
        "package_uninstall",
        true,
        "#",
...
$this->setItemBefore("package_uninstall","package_link",
        "item-js",
        $this->pathBase."media/sys/images/package-ok-32.png",
        "package_link",
        true,
        "#",
...
$this->setItemBefore("package_link","package_new",
        "item-js",
        $this->pathBase."media/sys/images/package-new-32.png",
        "package_new",
        true,
        "#",
