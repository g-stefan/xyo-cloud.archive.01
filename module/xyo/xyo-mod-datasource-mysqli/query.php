...
class xyo_mod_datasource_mysqli_Query extends xyo_Config {
	...
	function &copyThis() {
		$retV = new xyo_mod_datasource_mysqli_Query($this->module_, $this->connection_, $this->name_, $this->datasource_, $this->descriptor_, $this->as_, false);
		if ($retV) {
