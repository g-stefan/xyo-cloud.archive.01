...
class xyo_mod_datasource_xyo_Query extends xyo_Config {
    ...
    function &copyThis() {
        $retV = new xyo_mod_datasource_xyo_Query($this->module_, $this->connection_, $this->name_, $this->datasource_, true, $this->as_, false);
        if ($retV) {
