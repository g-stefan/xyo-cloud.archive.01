...
// result compare
//
function xyo_mod_datasource_csv_table__cmp($a, $b) {
...
class xyo_mod_datasource_csv_Table extends xyo_Config {
	...
	function &copyThis() {
		...
		$retV = new xyo_mod_datasource_csv_Table($this->module_, $this->connection_, $this->name_, $this->datasource_, $this->descriptor_, $this->as_, false);
		if ($retV) {
