...
class xyo_mod_datasource_sqlite_Table extends xyo_Config {
    ...
    function &copyThis() {
        ...
        $retV = new xyo_mod_datasource_sqlite_Table($this->module_, $this->connection_, $this->name_, $this->datasource_, $this->descriptor_, $this->as_, false);
        if ($retV) {
        ...
        foreach ($this->fieldType_ as $key_ => $value_) {
			...
			if($value_=="varchar"){
                ...
                if (array_key_exists($key_, $this->fieldDefaultValue_)) {
                    ...
                    if (is_int($this->fieldDefaultValue_[$key_])) {
