...
.xui-form-text-icon-right-required_<?php echo $key; ?> input{
	color: #000000;
	background-color: #FFFFFF;
...
.xui-form-text-icon-right-required_<?php echo $key; ?> i{
	color: <?php echo $value; ?>;	
}

<?php if($key!="default"){ ?>

.xui-form-text-icon-right-required_<?php echo $key; ?> input:focus{
	outline: none;
...
.xui-form-text-icon-right-required_<?php echo $key; ?> input:focus + i{
	color: <?php echo $value; ?>;	
}
