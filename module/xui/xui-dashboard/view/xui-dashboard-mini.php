...
<div style="position:relative;width:800px;height:400px;border:1px solid #000000">
	<div class="xui dashboard -mini -closed" id="dashboard-mode-mini">
		<!-- app-header -->
		<div class="xui app-header -elevation-4">
			...
			<div class="xui app-bar">
				<div class="xui button -size-40x40 -left -effect-ripple" onclick="XUI.Dashboard.toogleMini('dashboard-mode-mini');">
