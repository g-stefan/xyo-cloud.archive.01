...
$this->settings["form-button-primary-wall-color"]=$this->color->rgbHexHSLAdjust($this->settings["context-primary-color"],0,0,-15);
...
$this->settings["form-button-primary-focus-wall-color"]=$this->color->rgbHexHSLAdjust($this->settings["context-primary-focus-color"],0,0,-30);
//
...
$this->settings["form-button-success-wall-color"]=$this->color->rgbHexHSLAdjust($this->settings["context-success-color"],0,0,-15);
...
$this->settings["form-button-success-focus-wall-color"]=$this->color->rgbHexHSLAdjust($this->settings["context-success-focus-color"],0,0,-30);
//
...
$this->settings["form-button-info-wall-color"]=$this->color->rgbHexHSLAdjust($this->settings["context-info-color"],0,0,-15);
...
$this->settings["form-button-info-focus-wall-color"]=$this->color->rgbHexHSLAdjust($this->settings["context-info-focus-color"],0,0,-30);
//
...
$this->settings["form-button-warning-wall-color"]=$this->color->rgbHexHSLAdjust($this->settings["context-warning-color"],0,0,-15);
...
$this->settings["form-button-warning-focus-wall-color"]=$this->color->rgbHexHSLAdjust($this->settings["context-warning-focus-color"],0,0,-30);
//
...
$this->settings["form-button-danger-wall-color"]=$this->color->rgbHexHSLAdjust($this->settings["context-danger-color"],0,0,-15);
...
$this->settings["form-button-danger-focus-wall-color"]=$this->color->rgbHexHSLAdjust($this->settings["context-danger-focus-color"],0,0,-30);
//
