...
<div class="xui-form-file-image-thumbnail">
<div class="xui-form-file-image-thumbnail__image">
	<i class="material-icons">image</i>
</div>
<button type="button" class="xui-form-file-image-thumbnail__delete xui-form-button-icon xui-form-button-icon--danger xui--elevation-2" onclick="document.getElementById('x-file').value=null;$('#x-file').trigger('change');"><i class="material-icons">close</i></button>
