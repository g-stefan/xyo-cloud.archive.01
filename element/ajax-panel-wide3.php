...
?>
	...
	<div class="panel panel-default xyo-form-ajax-panel-wide3">
		<div class="panel-heading" id="<?php $this->eElementId($element) ?>_head">
			...
			<?php
				...
				foreach($buttons as $key=>$value){
					...
					echo "<a href=\"#\" onclick=\"javascript:".$value["js"]."\" class=\"pull-right xyo-form-ajax-panel-wide3-icon\">".$img."</a>";
				};				
...
?>
	<div class="panel panel-default xyo-form-ajax-panel-wide3" id="<?php $this->eElementId($element); ?>_collapse_parent">
		<div class="panel-heading" id="<?php $this->eElementId($element) ?>_head">
			<?php $this->eLanguage("label_" . $element); ?>
			<a data-toggle="collapse" data-parent="#<?php $this->eElementId($element); ?>_collapse_parent" href="#<?php $this->eElementId($element); ?>_collapse" class="xyo-form-ajax-panel-wide3-toggle <?php echo $collapseClassA; ?> pull-right">
