...
<br>
<select class="xui-form-select<?php if($this->isElementError($element)){echo " xui-form-select--danger";}; ?>" name="<?php $this->eElementName($element); ?>" id="<?php $this->eElementId($element); ?>">
<?php
