...
<br>
<div class="xui-form-text-icon-left-required<?php if($this->isElementError($element)){echo " xui-form-text-icon-left-required--danger";}; ?>" style="width:100%">
<input type="password"<?php echo $maxlength; ?> placeholder="" style="width:100%"
