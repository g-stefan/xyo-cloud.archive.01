...
<div class="form-group<?php if($this->isElementError($element)){echo " has-error";}; ?>">
	...
	<span class="xyo-form-file-image-thumbnail-delete-sub" onclick="$('#<?php $this->eElementId($element); ?>_delete').val(1);$('#<?php $this->eElementId($element); ?>_image').html('<?php echo $fileNameNone; ?>');return false;"><i class="glyphicon glyphicon-remove"></i></span>
    </div>
